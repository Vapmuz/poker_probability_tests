...
class GameAssembler(Deck):
    """class to handle the cards and the game, it inherited from Deck and Hand """
    ...
    def access_hand_class(self, to_test):
        """fucntion used to set up and test the accessibility of the Hands using the game asembler"""
        hand_test = Hand()
